...
*Whispers Between Us* is a text-based mystery set in an isolated Alpine village on a full-moon night. You navigate rooms, collect clues, and build — or destroy — trust with characters who each have their own version of the truth. The game never tells you what to do next. It only shows you what is there, and lets you decide what it means. Every decision you make changes what you can access, what people tell you, and how the night ends.
